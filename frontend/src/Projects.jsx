...
const Project = () => {
  ...
  const[projects, setProjects] = useState([
    {title: "Project Management Website", link:"https://thepmforge.vercel.app/", image: pm, description: "A project management website built with React.js and Tailwind css.", tools: ["React.js", "Tailwind CSS"]},
    ...
    {title:"Randoms", image:"", link:"https://github.com/FOA-developer/javascript_projects", description: "A collection of random projects that showcase a variety of skills and technologies, demonstrating versatility and creativity in web development all in one repository.", tools: ["HTML", "CSS", "JAVASCRIPT"]},
  ]);

  return ( 
    <section id="projects">
      <div className="bg-[#0a0a0a] flex flex-col pt-12 px-12 pb-8">
        <div>
          <div className="flex items-center gap-1 justify-start ">
            <div className="w-10 h-[2px] bg-[#FE4E02]"></div>
            <p className="text-[#FE4E02] font-mono text-semibold text-sm">PROJECTS</p>
          </div>
          <h2 className="text-white text-3xl md:text-5xl font-bold pt-5">Digital Works</h2>
        </div>
        <div  className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
          {projects.map((project, index) => (
            <div key={index} className={`bg-[#1a1a1a] flex flex-row  p-6 rounded-2xl shadow-lg border-[1px] border-white/10 hover:border-[#FE4E02]  hover:shadow-xl transition duration-500 `}>
